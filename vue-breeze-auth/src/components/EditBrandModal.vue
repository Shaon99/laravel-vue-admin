    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5">
          <form class="space-y-4" @submit.prevent="brandStore.updateBrand(form)">
            <div>
              <label
                for="name"
            ...
            >
              <span v-if="!brandStore.isButtonLoading">Add New Category</span>
              <span v-else>
                <svg
                  aria-hidden="true"
                  role="status"
...
watch(
  () => props.brand,
  (newBrand) => {
    form.value.brandName = newBrand.name;
