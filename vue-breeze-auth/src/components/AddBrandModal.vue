    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5">
          <form class="space-y-4" @submit.prevent="brandStore.storeBrand(form)">
            <div>
              <label
                for="name"
              ...
              />
              <p
                v-if="brandStore.formErrors.name"
              ...
              >
                ...
                <span>{{ brandStore.formErrors.name[0] }}</span>
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p
                v-if="brandStore.formErrors.file"
                class="text-xs text-red-500 flex items-center mt-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>{{ brandStore.formErrors.file[0] }}</span>
              </p>
            </div>
            ...
            <div class="mb-3 pt-0 text-center mx-auto">
              <img
                v-if="previewImage"
                :src="previewImage"
                class="w-1/4 h-2/4 mx-auto rounded-md"
                alt="Picture"
              />
            </div>
            ...
            <button
              ...
              :disabled="brandStore.isButtonLoading"
            >
              <span v-if="!brandStore.isButtonLoading">Add New Brand</span>
              <span v-else>
                <svg
                  aria-hidden="true"
                  role="status"
